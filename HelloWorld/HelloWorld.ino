...
#include "pins.h"  // for Oxocard Connect
...
#define BOARD "ESP32 - Oxocard Connect"

// int LED_BUILTIN = 19; // uncomment if LED_BUILIN is not defined
...
//  while (!Serial); // wait for serial port to connect. Needed for native USB.
  ...
  pinMode(LCD_LED, OUTPUT);  // Oxocard has no LED, therefore background LCD of display is used
}
