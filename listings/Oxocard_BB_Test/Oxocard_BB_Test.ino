...
void setup() 
{
  ...
  myEEPROM.setMemoryType(512); // Valid types: 0, 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048
...
void loop() 
{
  ...
  tft.drawString("V2 features", 120, 90);
  ...
  Serial.println("\nRead EEPROM");
  uint32_t eepromSizeBytes = myEEPROM.getMemorySizeBytes();
