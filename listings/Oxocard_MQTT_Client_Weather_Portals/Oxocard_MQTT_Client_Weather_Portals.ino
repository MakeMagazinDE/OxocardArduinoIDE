/*
 * File: Oxocard_MQTT_Client_Weather_Portals.ino
 *
...
#include <ArduinoMqttClient.h>  // V.0.1.8 
#include <ArduinoJson.h>        // V.7.4.2
#include <UrlEncode.h>          // V.1.0.1
...
void setupMQTT() 
{
  ...
  mqttClient.setUsernamePassword("cksensorhub@ttn", "NNSXS.BSYDS6NOFVGOM6RRICUN3DUWVS46QH6KQQLXSUI.XJY34NRPY3VC6GCRYBFGDKEXHGE2OWRLBF5KTEPKO3E7HNNKDVJA");
